...
class _SelectColorsProductScreenState extends State<SelectColorsProductScreen> {
  final RepairColorsController repairColorController =
      Get.put(RepairColorsController());
                ...
                child: repairColorController.isRepairColorsLoading.value
                    ...
                    : repairColorController.colorListRepair.isEmpty
                        ...
                        : GridView.builder(
                            ...
                            itemCount:
                                repairColorController.colorListRepair.length,
                            gridDelegate:
                            ...
                            itemBuilder: (context, index) {
                              final colorDetails =
                                  repairColorController.colorListRepair[index];
                              return GestureDetector(
                                onTap: () {
                                  print(
                                      'Selected color: ${colorDetails.colorName}, ID: ${colorDetails.colorId}');
                                  // Get.to(() => RepairServiceScreen());
                                  Get.to(() => SelectServicesScreen(
                                        brandId: colorDetails.brand.toString(),
                                        modelId:
                                            colorDetails.modelNo.toString(),
                                        colorId:
                                            colorDetails.colorId.toString(),
                                      ));
                                },
                                child: Container(
