...
import 'package:fonofy/controllers/SellControllers/SellVariantTableControllers.dart';
import 'package:fonofy/pages/SelectProductScreen/SelectProductScreen2.dart';
          ...
          child: ElevatedButton(
            onPressed: () {
              if (selectedVariant != null) {
                ...
                final ram =
                    variantParts.isNotEmpty ? variantParts[0].trim() : ' ';
                final rom =
                    variantParts.length > 1 ? variantParts[1].trim() : ' ';

                Get.to(() => SelectProductScreen2(
