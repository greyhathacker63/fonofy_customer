...
class CancelSellOrderScreen extends StatefulWidget {
  ...
  @override
  _CancelRepairOrderScreenState createState() =>
      _CancelRepairOrderScreenState();
}

class _CancelRepairOrderScreenState extends State<CancelSellOrderScreen> {
  final ControllerRepairCancelReasonList controllerRepairCancelReason =
      Get.put(ControllerRepairCancelReasonList());
  final SellCancelOrderController cancelOrderController =
      Get.put(SellCancelOrderController());
                        ...
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              // ✅ Only pop if the screen is still mounted
                              if (mounted &&
                                  cancelOrderController
                                      .cancelSellMessage.isNotEmpty) {
                                Navigator.pop(context);
                              }
                            },
                            style: ElevatedButton.styleFrom(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Obx(() {
                  if (controllerRepairCancelReason
                      .isRepairCancelReasonLoading.value) {
                    return const Center(
                        child: CircularProgressIndicator(
                            strokeWidth: 2, color: Colors.blue));
                  }

                  final reasons = controllerRepairCancelReason
                          .repairCancelReasonData?.table1 ??
                      [];
                  ...
                  return Column(
                    children: reasons.map((item) {
                      ...
                      return RadioListTile<String>(
                        ...
                        visualDensity: const VisualDensity(vertical: -4),
                        contentPadding: EdgeInsets.zero,
                        title: Text(itemReason,
                            style: const TextStyle(fontSize: 14)),
                        onChanged: (value) {
                          setState(() {
                            selectedReasonId = value;
                            selectedReasonText = itemReason;
                          });
                        },
                        activeColor: ColorConstants.appBlueColor3,
                      );
