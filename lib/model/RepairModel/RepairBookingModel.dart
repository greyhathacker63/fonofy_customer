...
class RepairBookingModel {
  ...
  factory RepairBookingModel.fromJson(Map<String, dynamic> json) => RepairBookingModel(
    ...
    couponPercent: (json["CouponPercent"] ?? 0.0).toDouble(),
    couponCode: json["CouponCode"] ?? '',
    repairType: json["RepairType"] ?? '',
    slotDate: json["SlotDate"] ?? '',
    remark: json["Remark"] ?? '',
    ...
    totalDiscount: (json["TotalDiscount"] ?? 0).toInt(),
    totalMrp: (json["TotalMRP"] ?? 0).toInt(),
    mode: json["Mode"] ?? '',
...
class RepairDetail {
  ...
  factory RepairDetail.fromJson(Map<String, dynamic> json) => RepairDetail(
    ...
    serviceName: json["ServiceName"] ?? '',
    serviceAmount: (json["ServiceAmount"] ?? 0.0).toDouble(),
    serviceDiscount: (json["ServiceDiscount"] ?? 0.0).toDouble(),
    servicePercent: json["ServicePercent"] ?? 0,
  );
