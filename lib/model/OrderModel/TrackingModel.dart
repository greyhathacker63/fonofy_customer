...
class TrackingModel {
  ...
  factory TrackingModel.fromJson(Map<String, dynamic> json) => TrackingModel(
        ...
        createdDate: json["CreatedDate"] == null ? null : DateTime.tryParse(json["CreatedDate"]),
        confirmDate: json["ConfirmDate"] == null ? null : DateTime.tryParse(json["ConfirmDate"]),
        confirmBy: json["ConfirmBy"]?.toString(),
        confirmRemark: json["ConfirmRemark"],
        dispatchDate: json["DispatchDate"] == null ? null : DateTime.tryParse(json["DispatchDate"]),
        dispatchBy: json["DispatchBy"]?.toString(),
        dispatchRemark: json["DispatchRemark"],
        deliverDate: json["DeliverDate"] == null ? null : DateTime.tryParse(json["DeliverDate"]),
        deliverBy: json["DeliverBy"]?.toString(),
        deliverRemark: json["DeliverRemark"],
        cancelDate: json["CancelDate"] == null ? null : DateTime.tryParse(json["CancelDate"]),
        ...
        returnInitiatedBy: json["ReturnInitiatedBy"]?.toString(),
